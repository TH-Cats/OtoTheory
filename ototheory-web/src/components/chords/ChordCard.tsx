...
import type { ChordShape } from '@/lib/chord-library';
import styles from '@/app/resources/chord-library/chords.module.css';

type Props = { symbol: string; shape: ChordShape; };

export function ChordCard({ symbol, shape }: Props) {
  ...
  return (
    <article className={styles['chord-card']}>
      ...
      <ChordDiagram frets={shape.frets} fingers={shape.fingers} barres={shape.barres} />
