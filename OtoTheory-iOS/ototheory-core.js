...
var OtoCore = (() => {
  ...
  var require_dist = __commonJS({
    "node_modules/@tonaljs/pitch/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(pitch_exports);
  ...
  var require_dist2 = __commonJS({
    "node_modules/@tonaljs/pitch-interval/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(pitch_interval_exports);
      ...
      function interval2(src) {
        return typeof src === "string" ? cache[src] || (cache[src] = parse(src)) : (0, import_pitch.isPitch)(src) ? interval2(pitchName(src)) : (0, import_pitch.isNamedPitch)(src) ? interval2(src.name) : NoInterval;
      }
      var SIZES = [0, 2, 4, 5, 7, 9, 11];
      var TYPES = "PMMPPMM";
      function parse(str) {
      ...
      function coordToInterval(coord, forceDescending) {
        ...
        return interval2((0, import_pitch.pitch)(ivl));
      }
  ...
  var require_dist3 = __commonJS({
    "node_modules/@tonaljs/pitch-note/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(pitch_note_exports);
      var import_pitch = require_dist();
      var fillStr = (s, n) => Array(Math.abs(n) + 1).join(s);
  ...
  var require_dist4 = __commonJS({
    "node_modules/@tonaljs/pitch-distance/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(pitch_distance_exports);
  ...
  var require_dist5 = __commonJS({
    "node_modules/@tonaljs/abc-notation/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(abc_notation_exports);
      ...
      function transpose2(note2, interval2) {
        return scientificToAbcNotation((0, import_pitch_distance.transpose)(abcToScientificNotation(note2), interval2));
      }
  ...
  var require_dist7 = __commonJS({
    "node_modules/@tonaljs/collection/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(collection_exports);
      function ascR(b, n) {
        const a = [];
        for (; n--; a[n] = n + b) ;
        return a;
  ...
  var require_dist8 = __commonJS({
    "node_modules/@tonaljs/pcset/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(pcset_exports);
  ...
  var require_dist9 = __commonJS({
    "node_modules/@tonaljs/chord-type/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(chord_type_exports);
      ...
      var NoChordType = __spreadProps(__spreadValues({}, import_pcset.EmptyPcset), {
        name: "",
        quality: "Unknown",
        intervals: [],
        aliases: []
      ...
      function add(intervals, aliases, fullName) {
        ...
        const chord = __spreadProps(__spreadValues({}, (0, import_pcset.get)(intervals)), {
          name: fullName || "",
          quality,
          intervals,
          aliases
  ...
  var require_dist10 = __commonJS({
    "node_modules/@tonaljs/chord-detect/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(chord_detect_exports);
      var import_chord_type = require_dist9();
      var import_pcset = require_dist8();
      var import_pitch_note = require_dist3();
      var namedSet = (notes) => {
        const pcToName2 = notes.reduce((record, n) => {
        ...
        return (chroma) => pcToName2[chroma];
      };
  ...
  var require_dist12 = __commonJS({
    "node_modules/@tonaljs/scale-type/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(scale_type_exports);
      var import_pcset = require_dist8();
      var SCALES = [
        // Basic scales
      ...
      var NoScaleType = __spreadProps(__spreadValues({}, import_pcset.EmptyPcset), {
        intervals: [],
        aliases: []
      });
      var dictionary = [];
      ...
      function add(intervals, name, aliases = []) {
        const scale = __spreadProps(__spreadValues({}, (0, import_pcset.get)(intervals)), { name, intervals, aliases });
  ...
  var require_dist13 = __commonJS({
    "node_modules/@tonaljs/chord/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(chord_exports);
      ...
      function transpose2(chordName, interval2) {
        ...
        const tr = (0, import_pitch_distance.transpose)(bass, interval2);
        const slash = tr ? "/" + tr : "";
        return (0, import_pitch_distance.transpose)(tonic, interval2) + type + slash;
      }
  ...
  var require_dist14 = __commonJS({
    "node_modules/@tonaljs/duration-value/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(duration_value_exports);
      var DATA = [
        [
          0.125,
          "dl",
      ...
      function get(name) {
        ...
        return __spreadProps(__spreadValues({}, base), { name, dots, value: value2, fraction: fraction2 });
      }
  ...
  var require_dist16 = __commonJS({
    "node_modules/@tonaljs/note/dist/index.js"(exports, module) {
      ...
      var transposeBy = (interval2) => (note) => transpose2(note, interval2);
      var trBy = transposeBy;
      var transposeFrom = (note) => (interval2) => transpose2(note, interval2);
  ...
  var require_dist17 = __commonJS({
    "node_modules/@tonaljs/roman-numeral/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(roman_numeral_exports);
      var import_pitch = require_dist();
      var import_pitch_interval = require_dist2();
      var import_pitch_note = require_dist3();
    ...
    "node_modules/@tonaljs/key/dist/index.js"(exports, module) {
      ...
      function keyScale(grades, triads, chordTypes, harmonicFunctions, chordScales) {
        return (tonic) => {
          ...
          const scale = intervals.map((interval2) => (0, import_note.transpose)(tonic, interval2));
  ...
  var require_dist19 = __commonJS({
    "node_modules/@tonaljs/mode/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(mode_exports);
      var import_collection = require_dist7();
      var import_interval = require_dist11();
      var import_pcset = require_dist8();
      var import_pitch_distance = require_dist4();
      ...
      var NoMode = __spreadProps(__spreadValues({}, import_pcset.EmptyPcset), {
        name: "",
        alt: 0,
        modeNum: NaN,
        triad: "",
  ...
  var require_dist20 = __commonJS({
    "node_modules/@tonaljs/progression/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(progression_exports);
  ...
  var require_dist22 = __commonJS({
    "node_modules/@tonaljs/rhythm-pattern/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(rhythm_patterm_exports);
  ...
  var require_dist23 = __commonJS({
    "node_modules/@tonaljs/scale/dist/index.js"(exports, module) {
      ...
      function get(src) {
        ...
        return __spreadProps(__spreadValues({}, st), { name, type, tonic, notes });
      }
      var scale = get;
      function detect2(notes, options = {}) {
        var _a, _b;
        const notesChroma = (0, import_pcset.chroma)(notes);
        const tonic = (0, import_pitch_note.note)((_b = (_a = options.tonic) != null ? _a : notes[0]) != null ? _b : "");
  ...
  var require_dist24 = __commonJS({
    "node_modules/@tonaljs/time-signature/dist/index.js"(exports, module) {
      ...
      module.exports = __toCommonJS2(time_signature_exports);
      var NONE = {
        empty: true,
        name: "",
        upper: void 0,
      ...
      function search(chord, range = defaultRange, dictionary = import_voicing_dictionary.default.triads) {
        ...
        return voicings.reduce((voiced, voicing) => {
          const relativeIntervals = voicing.map(
            (interval2) => import_interval.default.subtract(interval2, voicing[0]) || ""
          );
          ...
          const notes = starts.map(
            (start) => relativeIntervals.map((interval2) => import_note.default.transpose(start, interval2))
          );
  ...
  var require_dist28 = __commonJS({
    "node_modules/@tonaljs/core/dist/index.js"(exports, module) {
      ...
      var import_pitch = require_dist();
      __reExport(core_exports, require_dist(), module.exports);
      __reExport(core_exports, require_dist4(), module.exports);
      __reExport(core_exports, require_dist2(), module.exports);
      __reExport(core_exports, require_dist3(), module.exports);
      var fillStr = (s, n) => Array(Math.abs(n) + 1).join(s);
  ...
  var require_dist29 = __commonJS({
    "node_modules/tonal/dist/index.js"(exports, module) {
      ...
      var Chord = __toESM2(require_dist13());
      ...
      var Key3 = __toESM2(require_dist18());
      var Midi = __toESM2(require_dist15());
      ...
      __reExport(index_exports, require_dist28(), module.exports);
  ...
  // src/lib/theory.ts
  var import_tonal2 = __toESM(require_dist29());

  // src/lib/music/constants.ts
  ...
  var noteToPc = (n) => {
    var _a;
    const i = PC_NAMES.indexOf(n);
    if (i >= 0) return i;
    const flatMap = { Db: "C#", Gb: "F#", Ab: "G#", Bb: "A#", Eb: "D#", Cb: "B", Fb: "E" };
    const up = (_a = flatMap[n]) != null ? _a : n;
    return PC_NAMES.indexOf(up);
  };
  var transpose = (pc, by) => (pc + by + 12) % 12;
  function parseChord(sym) {
    ...
    const tonesRel = (_a = QUALITY_TONES[qual]) != null ? _a : QUALITY_TONES.M;
    const tones = tonesRel.map((iv) => transpose(root, iv));
    const bass = slash[1] ? noteToPc(slash[1]) : void 0;
  ...
  function rankKeys(chords) {
    ...
    const res = candidates.map(({ root, mode }) => {
      ...
      const label = `${PC_NAMES[root]} ${mode}`;
  ...
  function scoreKeyCandidates(prog) {
    ...
    return top.map((r) => {
      const key = { tonic: r.keyRoot, mode: r.mode };
  ...
  function detectCadence(prog, key) {
    ...
    if (degPrev === 7 && degLast === 0) return "perfect";
