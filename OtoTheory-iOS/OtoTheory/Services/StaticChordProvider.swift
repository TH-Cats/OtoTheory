    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "Cm-3-Root4",
                shapeName: "Root-4",
                frets: [F(11), F(13), F(11), F(10), .x, .x],
                fingers: [.two, .four, .two, .one, nil, nil],
                barres: [],
                tips: ["4弦ルート", "ハイポジション"]
            ),
            // Triad1 (1-3弦)
