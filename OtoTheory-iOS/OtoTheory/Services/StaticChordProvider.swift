    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "C-2-Root6",
                shapeName: "Root-6",
                frets: [F(8), F(10), F(10), F(9), F(8), F(8)],
            ...
            StaticForm(
                id: "C-4-Root4",
                shapeName: "Root-4",
                frets: [F(10), .x, F(10), F(10), F(12), .x],
                fingers: [.one, nil, .one, .two, .four, nil],
                barres: [],
                tips: ["4弦ルート", "コンパクト"]
            ),
            // Triad上 (上部3弦)
    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "C#-1-Root6",
                shapeName: "Root-6",
                frets: [F(9), F(11), F(11), F(10), F(9), F(9)],
                fingers: [.one, .three, .four, .two, .one, .one],
    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "D-2-Root6",
                shapeName: "Root-6",
                frets: [F(10), F(12), F(12), F(11), F(10), F(10)],
                fingers: [.one, .three, .four, .two, .one, .one],
    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "D#-1-Root6",
                shapeName: "Root-6",
                frets: [F(11), F(13), F(13), F(12), F(11), F(11)],
                fingers: [.one, .three, .four, .two, .one, .one],
            ...
            // Root-4 (13fr) - too high, skip
            // Triad上
            StaticForm(
                id: "D#-3-TriadHigh",
                shapeName: "トライアド上",
                frets: [F(8), F(8), F(8), .x, .x, .x],
                fingers: [.one, .two, .three, nil, nil, nil],
                barres: [],
                tips: ["1-3弦のみ", "明るい響き"]
            ),
    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "Cm-1-Root6",
                shapeName: "Root-6",
                frets: [F(8), F(11), F(10), F(8), F(8), F(8)],
                fingers: [.one, .four, .three, .one, .one, .one],
                barres: [StaticBarre(fret: 8, fromString: 1, toString: 6, finger: .one)],
                tips: ["6弦ルート", "フルバレー"]
            ),
            // Root-5 (3fr)
    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "C#m-1-Root6",
                shapeName: "Root-6",
                frets: [F(9), F(12), F(11), F(9), F(9), F(9)],
                fingers: [.one, .four, .three, .one, .one, .one],
                barres: [StaticBarre(fret: 9, fromString: 1, toString: 6, finger: .one)],
                tips: ["6弦ルート", "フルバレー"]
            ),
    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "Dm-2-Root6",
                shapeName: "Root-6",
                frets: [F(10), F(13), F(12), F(10), F(10), F(10)],
                fingers: [.one, .four, .three, .one, .one, .one],
                barres: [StaticBarre(fret: 10, fromString: 1, toString: 6, finger: .one)],
                tips: ["6弦ルート", "ハイポジション"]
            ),
    ...
    StaticChord(
        ...
        forms: [
            ...
            StaticForm(
                id: "D#m-1-Root6",
                shapeName: "Root-6",
                frets: [F(11), F(14), F(13), F(11), F(11), F(11)],
                fingers: [.one, .four, .three, .one, .one, .one],
                barres: [StaticBarre(fret: 11, fromString: 1, toString: 6, finger: .one)],
                tips: ["6弦ルート", "ハイポジション"]
            ),
