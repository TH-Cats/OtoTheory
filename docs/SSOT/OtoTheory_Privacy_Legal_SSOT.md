...
**Account Deletion**: In‑app (Settings > Delete Account). Cloud data is purged within 30 days.
...
> **運用メモ**: `yarn licenses generate-disclaimer` 等で出力し本ページに貼付してください。
