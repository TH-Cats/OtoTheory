...
ツールチップ（iマーク）で表示される説明文の翻訳ルール：

| 英語 | 日本語 |
|------|--------|
| Build Progression | コード進行を作る |
| Choose Chords | コードを選ぶ |
| Chord Library | コード辞典 |
| Find Chords | コードを探す |
| Resources | 参考 |

**重要**: 
- **ツールチップ内の説明文は、完全に日本語または英語で統一する**
- 日本語ツールチップ内に英語の用語を混在させない
- 英語ツールチップ内に日本語の用語を混在させない
- 用語の翻訳は本表の「メニュー」「コード進行」セクションを参照
